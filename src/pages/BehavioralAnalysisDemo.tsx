      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center gap-3">
            ...
            Behavioral Data Analysis Demo
          </h1>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Experience the full data analysis workflow: ask questions, get AI-driven insights, 
            explore visualizations, and receive recommendations for deeper analysis.
          </p>
        </div>
...
export default BehavioralAnalysisDemo;
