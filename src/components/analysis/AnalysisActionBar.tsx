...
const AnalysisActionBar: React.FC<AnalysisActionBarProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-50 p-8 rounded-xl border-2 border-blue-200 mb-8 shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Button
          ...
          size="lg"
          className="h-auto p-6 bg-gradient-to-br from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 flex flex-col items-center gap-3 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200"
        >
        ...
        <Button
          ...
          size="lg"
          className="h-auto p-6 bg-gradient-to-br from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 flex flex-col items-center gap-3 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200"
        >
